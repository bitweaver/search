...
// $Header: /cvsroot/bitweaver/_bit_search/admin/admin_search_inc.php,v 1.1.1.1.2.7 2006/04/17 06:50:25 squareing Exp $
...
foreach( array_keys( $formSearchInts ) as $item ) {
